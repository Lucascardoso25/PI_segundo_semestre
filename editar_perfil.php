...
<body>
  <div class="topbar">
    <div class="logos">
      <img src="img/logo-fatec.png" alt="Fatec">
      <img src="img/cps_logo.png" alt="CPS">
    </div>
  ...
  <div class="container">
    <div class="center-flex">
      <div class="card">
        ...
        <?php if (!empty($u['foto'])): ?>
          <img src="<?= htmlspecialchars($u['foto']) ?>" class="avatar" alt="foto" />
        <?php else: ?>
          <p>(sem foto)</p>
        <?php endif; ?>
        ...
        <form action="processa_editar_perfil.php" method="post" enctype="multipart/form-data">
          <?= csrf_field(); ?>
          <label>Nova foto (jpg/png, max 2MB)</label>
          <input type="file" name="foto" accept=".jpg,.jpeg,.png" required />
          <div style="margin-top:12px;">
            <button class="btn" type="submit">Atualizar Foto</button>
            <a class="btn btn-secondary" href="menu_aluno.php" style="margin-left:8px;">Voltar</a>
          </div>
        </form>
      </div>
    </div>
